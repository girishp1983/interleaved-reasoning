# interleaved-reasoning: why & how?

Many API providers including OpenAI, Anthropic, MiniMax have implemented interleaved reasoning. That has created some confusion. It is a powerful technique. The person of this repository is to provide a clear understanding on this topic: including how to deal with these APIs to take advantage of the feature, and what are the impacts on caching.
